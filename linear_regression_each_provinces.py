    ...
    for file_path in file_paths:
        ...
        for province in df['province'].unique():
            ...
            if province != "Canada":
                ...
                mse_dict[f"{file_name}: {province}_{target}"] = mse_lr

                print(f"{file_name}: {province}_{target} MSE = {mse_lr:.2f}")
...
mse_df.to_csv('D:\\winter2023\\CSCI6405\\project\\linear_regression_each_province\\each_province_overall_'+target+'_'+year+'.csv')
