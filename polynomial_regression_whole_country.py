...
# mse_df.to_csv('D:\\winter2023\\CSCI6405\\project\\linear_regression_each_province\\whole_country_overall_education_2021.csv')
...
mse_df = pd.DataFrame.from_dict(mse_dict, orient='index', columns=['MSE'])
mse_df.index.name = 'Index'
mse_df.to_csv('D:\\winter2023\\CSCI6405\\project\\linear_regression_each_province\\whole_country_detailed_'+target+'_'+year+'.csv')